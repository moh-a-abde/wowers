Now I have all the data I need. Here is the comprehensive architecture plan.
...
| Phase 2: Energy Yield | Not started | `energy_yield_estimates.parquet` | Monte Carlo over head distributions |
