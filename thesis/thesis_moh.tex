...
% ---------------------------------------------------------------------
% MERGED 2026-08-06: M1 and M2 below have been pasted into thesis_tom.tex
% (§4.6 Frontend Visualization System and §5.1.6 Frontend Performance),
% with headings demoted (\section→\subsection for M1, \subsection*→bold
% run-in lead-ins for M2 to match Tom's house style) and the six
% \bibitem entries folded into thesis_tom.tex's single bibliography.
% Verified: 0 compile errors, 0 undefined refs/citations, pages visually
% inspected. thesis_tom.tex is now the sole live copy of this content —
% this file is kept as the drafting record only; do not edit it expecting
% changes to propagate anywhere.
%
