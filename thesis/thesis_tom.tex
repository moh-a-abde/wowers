...
\wptodo{T3 · 4.3.1}{Feeds: filter\_potw.py, flow\_features.py, PHASE1\_REPORT.md.}
...
\wptodo{T3 · 4.3.3}{Feeds: energy\_physics.py, monte\_carlo.py, head\_assumptions.py,
PHASE2\_REPORT.md. Site-keyed seeding, P10/P50/P90.}
